...
void SenderToServer::LaunchMsgLoop()
{
    ...
    // The following section is commented to get motion editor working with Gazebo. The reason
    // is that Gazebo doesn't allow adding agent to the simulator while playMode is PlayOn.
//    if (mPort != -1)
//    {
//        msg = "(playMode PlayOn)";
