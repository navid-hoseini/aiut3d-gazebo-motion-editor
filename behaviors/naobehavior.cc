    ...
    namedParams( namedParams_ ), rsg( rsg_ )
{
    ...
    try {
        ...
        skills[SKILL_MOTION_EDITOR] = shared_ptr<Skill>(new Skill());
...
void NaoBehavior::addKeyframeToSkill(SkillType skillIndex, shared_ptr<KeyFrame> keyframe)
{
...
void NaoBehavior::editSkill(SkillType skillIndex, int &keyframeIndex, shared_ptr<KeyFrame> &newKeyframeData)
{
