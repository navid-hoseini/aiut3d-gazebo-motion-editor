...
public:
    ...
    map< SkillType, shared_ptr<Skill> > getSkills()
    {
        return skills;
    }
    void addKeyframeToSkill(SkillType skillIndex, shared_ptr<KeyFrame> keyframe);

    void deleteKeyframeFromSkill(SkillType skillIndex, int keyframeIndex);
    void deleteAllKeyframesFromSkill(SkillType skillIndex);

    void editSkill(SkillType skillIndex, int &keyframeIndex, shared_ptr<KeyFrame> &newKeyframeData);
    ...
    //AI lab hoseini 97-03-18 start
    inline bool getInitBeamed()
    {
        return initBeamed;
    }
    //AI lab hoseini 97-03-18 end
};
